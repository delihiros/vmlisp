...
TEST(Lexer, integer) {
    ...
    EXPECT_EQ(token.get_tokentype(), TokenType::Integer);
...
TEST(Lexer, double) {
    ...
    EXPECT_EQ(token.get_tokentype(), TokenType::Double);
...
TEST(Lexer, symbol) {
    ...
    EXPECT_EQ(token.get_tokentype(), TokenType::Symbol);
...
TEST(Lexer, keyword) {
    ...
    auto token = lexer->next();
    EXPECT_EQ(token.get_string(), ":abc");
    EXPECT_EQ(token.get_tokentype(), TokenType::Keyword);
...
TEST(Lexer, comment) {
    ...
    EXPECT_EQ(token.get_tokentype(), TokenType::Comment);
...
TEST(Lexer, string) {
    ...
    auto token = lexer->next();
    EXPECT_EQ(token.get_string(), "hello, world");
    EXPECT_EQ(token.get_tokentype(), TokenType::String);
